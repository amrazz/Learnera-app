...
from teachers.models import Assignment, AssignmentSubmission, Attendance, Exam, StudentExam
...
class StudentDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Student
        fields = [
            "id", "user", "admission_number", "roll_number", 
            "class_assigned", "academic_year", "class_teacher",
            "attendance_summary"
        ]
...
class StudentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Student
        fields = ['id', 'admission_number', 'roll_number', 'class_name', 'section_name', 'last_name', 'first_name']
...
class AssignmentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Assignment
        fields = ['id', 'title', 'description', 'subject_name', 'last_date', 'submission_status']
...
class ExamSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Exam
        fields = ['id', 'title', 'subject_name', 'start_time', 'end_time', 'total_mark', 'exam_status']
...
class StudentLeaveRequestSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id', 'leave_type', 'start_date', 'end_date', 'reason', 'status', 'applied_on']

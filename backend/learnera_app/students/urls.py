...
from .views import AssignmentSubmissionView, AttendanceStatisticsView, StartExamView, StudentAnswerCreateView, StudentAnswerUpdateView, StudentAssignmentListView, StudentAttendanceView, StudentDashboard, StudentExamPreparationView, StudentExamListView, StudentExamResultsView, StudentLeaveRequestDetailView, StudentLeaveRequestListCreateView, SubmitExamView
...
urlpatterns = [
    ...
    path('leave-requests/', StudentLeaveRequestListCreateView.as_view(), name='student-leave-request-list'),
    path('leave-requests/<int:pk>/', StudentLeaveRequestDetailView.as_view(), name='student-leave-request-detail'),
